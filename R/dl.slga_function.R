...
#' which can be used to point the [get.S.ECs()] to if used repeatedly. This will require a fast internet connection and the files will total approximately 60Gb.
#'
...
#' @param dlprompt Logical. Should the user be prompted to approve the total download size? Default = FALSE.
#'
