...
[![](images/logo-01.png){width="300"}](https://github.com/NickFlagleaf/EC4MET)
...
An example dataset of gridded environment locations that cover the extend of the Australian wheat belt is also included in the package. This dataset includes unique 5,091 environments between 2018 and 2020.
